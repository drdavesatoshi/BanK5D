...
const Layout=({children,className=``})=>/*#__PURE__*/index_js_.createElement(index_js_.Fragment,null,/*#__PURE__*/index_js_.createElement(emotion_react_esm/* Global */.mL,{styles:t=>({"*":{boxSizing:`inherit`,"&:before":{boxSizing:`inherit`},"&:after":{boxSizing:`inherit`}},"[hidden]":{display:`none`},"::selection":{backgroundColor:(0,theme_ui_css_esm/* get */.Jt)(t,`colors.primary`),color:(0,theme_ui_css_esm/* get */.Jt)(t,`colors.background`)}})}),/*#__PURE__*/index_js_.createElement(lib/* MDXProvider */.xA,{components:mdx_components},/*#__PURE__*/index_js_.createElement("main",{className:className},children)));/* harmony default export */ const layout = (Layout);
...
*/
var aa=__webpack_require__(3117),ca=__webpack_require__(9982);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
function react_spring_shared_modern_useForceUpdate() {
  const update2 = (0,index_js_.useState)()[1];
